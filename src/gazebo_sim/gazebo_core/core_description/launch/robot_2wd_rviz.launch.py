...
def generate_launch_description():
    ...
    rviz_config_arg = DeclareLaunchArgument('rviz_config', default_value='robot_2wd.rviz',
                          description='rviz config file')
    robot_model_arg = DeclareLaunchArgument('urdf_model', default_value='robot_2wd.urdf.xacro',
